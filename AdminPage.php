...
<body>
  <header class="header">
    ...
    <a href="#" class="logo"><span>Fast</span>Hospital Service</a>
    <nav class="navbar">
  ...
  <section class="home" id="home">
    ...
    <img src="./images/image0.jpg" class="home-parallax" data-speed="5" alt="" />
 ...
 Not Deleted
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Doctor ID</label>
                    <input type="text" class="form-control" id="MDID" name="MDID" />
                  </div>
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Expertise</label>
                    <input type="text" class="form-control" id="MExpertise" name="MExpertise" />
                  </div>
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Password</label>
                    <input type="password" class="form-control" id="MDPassword" name="MDPassword" />
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="MDcity" name="MDcity" />
                  </div>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal1" data-whatever="@mdo">
          Modify Patients</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Password</label>
                    <input type="text" class="form-control" id="MPPassword" name="MPPassword" />
                  </div>
                  <button type="submit" class="btn btn-primary">
                    Update Details
                  </button>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo">
          Delete Cities</a>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal3" data-whatever="@mdo">
          Delete Doctors</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Doctor ID:</label>
                    <input type="text" class="form-control" id="DDID" name="DDID" />
                  </div>
                  <button type="submit" class="btn btn-primary">
                    Delete Doctors
                  </button>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal4" data-whatever="@mdo">
          Delete Patients</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Patient ID:</label>
                    <input type="text" class="form-control" id="DPID" name="DPID" />
                  </div>
                  <button type="submit" class="btn btn-primary">
                    Delete
                  </button>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal5" data-whatever="@mdo">
          Add Doctors</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Expertise</label>
                    <input type="text" class="form-control" id="AExpertise" name="AExpertise" />
                  </div>
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Password</label>
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">City</label>
                    <input type="text" class="form-control" id="ACity" name="ACity" />
                  </div>
                  <button type="submit" class="btn btn-primary">
                    Add Doctor
                  </button>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal6" data-whatever="@mdo">
          Add Patients</a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="AdminPage.php" method="post">
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Patient ID</label>
                    <input type="text" class="form-control" id="APID" name="APID" />

                  </div>

                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Password</label>
                    <input type="password" class="form-control" id="password" name="APPassword" />
                  </div>
                  <button type="submit" class="btn btn-primary">
                    Add Patients
                  </button>
      ...
      <div class="swiper-slide box">
        ...
        <a href="" class="btn" data-toggle="modal" data-target="#exampleModal7" data-whatever="@mdo">
          Add Cities</a>
